                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" action="{{ route('smph_msk.update', $smph_msk->id_sampahmasuk) }}"
                                class="p-2">
                                @csrf
                                @method('PUT')

                                <div class="form-group">
                                    <label for="edit_tgl_sampahmasuk">Tanggal Sampah Masuk</label>
                                    <input type="date" id="edit_tgl_sampahmasuk" name="tgl_sampahmasuk"
                                        class="form-control" value="{{ $smph_msk->tgl_sampahmasuk }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="edit_total_sampahmasuk">Total Sampah Masuk</label>
                                    <input type="text" id="edit_total_sampahmasuk" name="total_sampahmasuk"
                                        class="form-control" value="{{ $smph_msk->total_sampahmasuk }}" required>
                                </div>
