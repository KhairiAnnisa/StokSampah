                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form method="POST" action="{{ route('warga.update', $warga->id_warga) }}" class="p-2">
                                @csrf
                                @method('PUT')

                                <div class="form-group">
                                    <label for="edit_nama_warga">Nama Warga</label>
                                    <input type="text" id="edit_nama_warga" name="nama_warga" class="form-control"
                                        value="{{ $warga->nama_warga }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="edit_no_hp_warga">Nomor Handphone Warga</label>
                                    <input type="text" id="edit_no_hp_warga" name="no_hp_warga" class="form-control"
                                        value="{{ $warga->no_hp_warga }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="edit_blok">Blok</label>
                                    <input type="text" id="edit_blok" name="blok" class="form-control"
                                        value="{{ $warga->blok }}" required>
                                </div>

                                <div class="form-group">
                                    <label for="edit_alamat">Alamat</label>
                                    <textarea id="edit_alamat" name="alamat" class="form-control" rows="3">{{ $warga->alamat }}</textarea>
                                </div>
