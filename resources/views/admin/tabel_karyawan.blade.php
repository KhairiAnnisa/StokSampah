        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/karyawan" id="formTambahDataForm" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input id="nama_karyawan" name="nama_karyawan" class="form-control" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="posisi" name="posisi" class="form-control" required>
                        </div>
