            ...
            <form action="{{ route('laporan.cetak') }}" method="GET">
                <div class="form-row align-items-end">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-check form-check-inline col-md-4">
                            <input class="form-check-input" type="checkbox" id="penjualan_sampah" name="kategori[]"
                                value="penjualan_sampah">
                            <label class="form-check-label" for="penjualan_sampah">Penjualan Sampah</label>
                        </div>
                    </div>
                </div>
