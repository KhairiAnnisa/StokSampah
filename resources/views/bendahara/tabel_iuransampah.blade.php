    ...
    <main id="main" class="main">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/iuran_sampah" id="formTambahDataForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input id="bulan" name="bulan" class="form-control" required>
                            </div>

                            <div class="form-group">
                                <label for="tgl_iuransampah">Tanggal Pembayaran</label>
                                <input type="date" id="tgl_iuransampah" name="tgl_iuransampah" class="form-control"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="harga" name="harga" class="form-control" required>
                            </div>
        ...
        <section class="section">
            <button id="btnTambahData" class="btn-green" data-toggle="modal" data-target="#tambahDataModal">Tambah
                Data</button>
            <a href="{{ route('iuransampah.cetak') }}" class="btn-white-green-border" target="_blank">Cetak Data</a>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
